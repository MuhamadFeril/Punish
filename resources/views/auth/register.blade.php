            ...
            <div id="step-1">
                ...
                <div class="grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input-wrapper">
                            <span class="form-input-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg></span>
...
<script>
    function updateStepper(step) {
        ...
        if (step === 1) {
            title.innerText = 'Step 1 dari 3 : Informasi Akun';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Automatically go to step 2 only if there is a captcha error AND step 1 is completely valid (has values for all required fields)
        // Usually, password is empty after a reload, so we must start at step 1.
        @if($errors->has('captcha') || $errors->has('otp'))
            // Do not switch to step 2 automatically because the user needs to re-enter their password
        @endif
    });
</script>
@endsection
